...
- `correction`: residual-correction metadata, including day-boundary carry-over, day-level bias, and business-type transition calibration flags such as `businessTypeTransitionApplied` and `businessTypeTransitionBiasMw`
