...
가드는 보수적으로 동작합니다. 전체 예측선을 강제로 내리는 것이 아니라, 허용 가능한 반등폭을 넘은 초과분만 줄입니다. 더운 저녁의 실제 수요 증가를 과하게 누르지 않도록 기상 allowance도 함께 둡니다.
...
- `residualCarryoverByHour`의 시간별 cap, rebound, weather allowance, reduction 정보
