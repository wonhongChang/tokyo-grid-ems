...
| `metrics/model_promotion.json` | Champion/Challenger 28/56/84-day validation, drift, shadow, and recovery decision |
| `metrics/model_shadow_evaluation.json` | Artifact-bound shadow evidence required before degraded-Champion recovery approval |
