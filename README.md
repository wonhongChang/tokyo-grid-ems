...
- **Validation**: Generates previous-day operation reports, TEPCO-comparison metrics, LightGBM backtests, and UI-hidden internal diagnostics JSON
...
| `reports/internal/daily-diagnostics/*.json` | Internal lag/weather feature diagnostics, stored with operational outputs but not linked in the UI |
