...
| `metrics/model_contract_comparison.json` | Same-cutoff v11/v13/v14 recovery comparison bound to the promoted artifact |
...
- [2026-08-21 v14 champion-preserving calibration](docs/en/model-improvements/model-improvement-2026-08-21-v14-champion-preserving-calibration.md)
