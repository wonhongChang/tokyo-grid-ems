...
- **Validation**: Generates previous-day operation reports, forecast snapshots, TEPCO-comparison metrics, LightGBM backtests, and UI-hidden internal diagnostics JSON
...
- [2026-05-18 official JMA weather forecast input](docs/en/model-improvements/model-improvement-2026-05-18-official-jma-weather.md)
- [2026-05-18 lag-gap features and observed weather correction](docs/en/model-improvements/model-improvement-2026-05-18-lag-gap-and-observed-weather.md)
- [2026-05-19 weather bias and intraday ramp guards](docs/en/model-improvements/model-improvement-2026-05-19-weather-bias-and-ramp-guards.md)
- [2026-05-19 operational intraday drop guard](docs/en/model-improvements/model-improvement-2026-05-19-operational-intraday-drop-guard.md)
- [2026-05-19 forecast snapshots and shape diagnostics](docs/en/model-improvements/model-improvement-2026-05-19-operational-snapshots-and-shape-diagnostics.md)
- [2026-05-19 afternoon thermal inertia and shape guard](docs/en/model-improvements/model-improvement-2026-05-19-afternoon-thermal-inertia-shape-guard.md)
- [2026-05-19 observed demand drop relaxation](docs/en/model-improvements/model-improvement-2026-05-19-observed-demand-drop-relaxation.md)
