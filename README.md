...
- OpenAI usage is capped by default to 3 calls: English master analysis (`OPENAI_DAILY_REPORT_MODEL`, default `gpt-5.4-mini`), Korean/Japanese localization (`OPENAI_DAILY_REPORT_LOCALIZATION_MODEL`, default `gpt-4o-mini`), and one low-cost localization retry when the first localized output fails validation.
...
- [2026-05-27 midday transition guard re-enabled](docs/en/model-improvements/model-improvement-2026-05-27-midday-transition-guard-reenabled.md)
