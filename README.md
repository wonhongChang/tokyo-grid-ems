...
| `metrics/model_promotion.json` | Champion/Challenger decision with rolling 28-day and prediction-drift gates |
...
- [2026-07-31 regime-aware non-business q50 ensemble](docs/en/model-improvements/model-improvement-2026-07-31-regime-aware-non-business-q50.md)
- [2026-07-27 fail-closed model promotion gate](docs/en/model-improvements/model-improvement-2026-07-27-promotion-gate-fail-closed.md)
- [2026-07-26 model governance and source integrity](docs/en/model-improvements/model-improvement-2026-07-26-model-governance-and-source-integrity.md)
- [2026-07-18 weekday lag-24 residual ensemble](docs/en/model-improvements/model-improvement-2026-07-18-weekday-lag24-residual-ensemble.md)
- [2026-07-18 declining-shape analog uplift cap](docs/en/model-improvements/model-improvement-2026-07-18-declining-analog-uplift-cap.md)
- [2026-07-16 morning ramp slope overreaction guard](docs/en/model-improvements/model-improvement-2026-07-16-morning-ramp-slope-overreaction.md)
- [2026-07-16 evening ramp drop-cap retuning](docs/en/model-improvements/model-improvement-2026-07-16-evening-ramp-drop-cap-retuning.md)
