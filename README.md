...
- OpenAI usage is capped by default to 2 calls: English master analysis (`OPENAI_DAILY_REPORT_MODEL`, default `gpt-5.4-mini`) + Korean/Japanese localization (`OPENAI_DAILY_REPORT_LOCALIZATION_MODEL`, default `gpt-4o-mini`).
...
- [2026-05-25 positive residual slope damping](docs/en/model-improvements/model-improvement-2026-05-25-positive-residual-slope-damping.md)
- [2026-05-25 business-return anchor shortfall guard](docs/en/model-improvements/model-improvement-2026-05-25-business-return-anchor-shortfall.md)
- [2026-05-25 business-day return lag24 cap fix](docs/en/model-improvements/model-improvement-2026-05-25-business-return-lag24-cap.md)
- [2026-05-23 negative residual recovery damping](docs/en/model-improvements/model-improvement-2026-05-23-negative-residual-recovery-damping.md)
- [2026-05-23 non-business transition calibration](docs/en/model-improvements/model-improvement-2026-05-23-non-business-transition-calibration.md)
